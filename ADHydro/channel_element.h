...
// channel_element.decl.h needs CProxy_MeshElement from mesh_element.decl.h, but mesh_element.decl.h needs CProxy_ChannelElement from channel_element.decl.h.
...
private:
  ...
  void handleInitialize(CProxy_MeshElement meshProxyInit, CProxy_FileManager fileManagerProxyInit, double elementXInit, double elementYInit,
                        double elementZBankInit, double elementZBedInit, double elementLengthInit, int channelNeighborsInit[channelNeighborsSize],
  ...
  ChannelTypeEnum channelType;   // What type of channel is element.
