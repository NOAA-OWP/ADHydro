  ...
  if (NULL == meshConductivity && NULL != meshVegetationType && NULL != meshSoilType)
    {
      ...
      for (ii = 0; ii < localNumberOfMeshElements; ii++)
        {
          // FIXME calculate value from meshVegetationType and meshSoilType
          meshConductivity[ii] = 0.000555;
        }
    }
  
  // Calculate meshPorosity from vegetation and soil type.
  if (NULL == meshPorosity && NULL != meshVegetationType && NULL != meshSoilType)
    {
