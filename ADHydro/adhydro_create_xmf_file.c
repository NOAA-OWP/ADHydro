...
fprintf(output,"    <Grid CollectionType=\"Temporal\" GridType=\"Collection\" Name=\"Mesh\">\n\n"); 
 ...
 for (nn = 0; nn < numgrps_stt; nn++)
 {
	...
	err_status = nc_get_att_int (grpid_stt[nn], NC_GLOBAL, "parameterGroup", &grp_par);
 	...
 	err_status = nc_inq_dimid (grpid_stt[ nn ],"numberOfMeshElements" , &neleID);
 	if (err_status != NC_NOERR)
 	{
 	...
 	// # elements  
 	err_status = nc_inq_dimlen  (grpid_stt[ nn ], neleID, &nele);
  	if (err_status != NC_NOERR)
 	{
  	...
  	err_status = nc_inq_dimid (grpid_stt[ nn ],"numberOfMeshNodes" , &nnodeID);
  	if (err_status != NC_NOERR)
 	{
      	   printf("Problem getting dimmesion id from ../state.nc\n");
           exit(0);
 	...
 	// dimension size  
 	err_status = nc_inq_dimlen  (grpid_stt[ nn ], nnodeID, &nnode);
  	if (err_status != NC_NOERR)
 	{
    	    printf("Problem getting dimmesion from ../state.nc\n");
      	    exit(0);
...
fprintf(output,"        <Topology NumberOfElements=\"%zu\" Type=\"Triangle\">\n",nele);
fprintf(output,"          <DataItem DataType=\"Int\" Dimensions=\"%zu 3\" Format=\"HDF\">geometry.nc:/%i/meshElementNodeIndices</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Topology>\n");
fprintf(output,"        <Geometry Type=\"XYZ\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu 3\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshNodeXYZSurfaceCoordinates</DataItem>\n",nnode,grp_geo);
fprintf(output,"        </Geometry>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Node\" Name=\"NodeZBedrock\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\" 8\">geometry.nc:/%i/meshNodeZBedrockCoordinates</DataItem>\n",nnode,grp_geo);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Edge\" Name=\"EdgeLength\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu 3\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshEdgeLength</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Edge\" Name=\"EdgeNormalX\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu 3\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshEdgeNormalX</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Edge\" Name=\"EdgeNormalY\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshEdgeNormalY</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementX\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshElementX</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementY\">\n");
fprintf(output,"          \n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshElementY</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementZSurface\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshElementZSurface</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementZBedrock\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshElementZBedrock</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementArea\">\n");  
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">geometry.nc:/%i/meshElementArea</DataItem>\n",nele,grp_geo);
fprintf(output,"        </Attribute>\n"); 
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementCatchment\">\n");
fprintf(output,"          <DataItem DataType=\"Int\" Dimensions=\"%zu\" Format=\"HDF\">parameter.nc:/%i/meshElementCatchment</DataItem>\n",nele,grp_par); 
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementConductivity\">\n"); 
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">parameter.nc:/%i/meshElementConductivity</DataItem>\n",nele,grp_par);
fprintf(output,"        </Attribute>\n"); 
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementPorosity\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">parameter.nc:/%i/meshElementPorosity</DataItem>\n",nele,grp_par); 
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementManningsN\">\n"); 
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">parameter.nc:/%i/meshElementManningsN</DataItem>\n",nele,grp_par);			
fprintf(output,"        </Attribute>\n"); 
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementSurfacewaterDepth\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshElementSurfacewaterDepth</DataItem>\n",nele,grp_stt_name); 
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementSurfacewaterError\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshElementSurfacewaterError</DataItem>\n",nele,grp_stt_name);
fprintf(output,"        </Attribute>\n"); 
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementGroundwaterHead\">\n");
fprintf(output,"           <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshElementGroundwaterHead</DataItem>\n",nele,grp_stt_name);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementGroundwaterError\">\n"); 
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshElementGroundwaterError</DataItem>\n",nele,grp_stt_name);
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Cell\" Name=\"ElementGroundwaterRecharge\">\n"); 
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshElementGroundwaterRecharge</DataItem>\n",nele,grp_stt_name); 
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Edge\" Name=\"EdgeSurfacewaterFlowRate\">\n"); 
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu 3\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshEdgeSurfacewaterFlowRate</DataItem>\n",nele,grp_stt_name);
fprintf(output,"        </Attribute>\n"); 
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Edge\" Name=\"EdgeSurfacewaterCumulativeFlow\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu 3\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshEdgeSurfacewaterCumulativeFlow</DataItem>\n",nele,grp_stt_name); 
fprintf(output,"        </Attribute>\n");
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Edge\" Name=\"EdgeGroundwaterFlowRate\">\n"); 
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu 3\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshEdgeGroundwaterFlowRate</DataItem>\n",nele,grp_stt_name);
fprintf(output,"        </Attribute>\n"); 
fprintf(output,"        <Attribute AttributeType=\"Scalar\" Center=\"Edge\" Name=\"EdgeGroundwaterCumulativeFlow\">\n");
fprintf(output,"          <DataItem DataType=\"Float\" Dimensions=\"%zu 3\" Format=\"HDF\" Precision=\"8\">state.nc:/%s/meshEdgeGroundwaterCumulativeFlow</DataItem>\n",nele,grp_stt_name); 
fprintf(output,"        </Attribute>\n");
fprintf(output,"      </Grid>\n\n");
