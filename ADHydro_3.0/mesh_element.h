...
public:
        ...
        transpirationRate(0.0), transpirationCumulativeShortTerm(0.0), transpirationCumulativeLongTerm(transpirationCumulative), neighbors(neighbors), neighborsFinished(0)
    {
        ...
        {
            evapoTranspirationState.fIceOld[0] = 0.0f;
            evapoTranspirationState.fIceOld[1] = 0.0f;
            evapoTranspirationState.fIceOld[2] = 0.0f;
            evapoTranspirationState.albOld     = 1.0f;
            evapoTranspirationState.snEqvO     = 0.0f;
            evapoTranspirationState.stc[0]     = 0.0f;
            evapoTranspirationState.stc[1]     = 0.0f;
            evapoTranspirationState.stc[2]     = 0.0f;
            evapoTranspirationState.stc[3]     = 300.0f;
            evapoTranspirationState.stc[4]     = 300.0f;
            evapoTranspirationState.stc[5]     = 300.0f;
            evapoTranspirationState.stc[6]     = 300.0f;
            evapoTranspirationState.tah        = 300.0f;
            evapoTranspirationState.eah        = 2000.0f;
            evapoTranspirationState.fWet       = 0.0f;
            evapoTranspirationState.canLiq     = 0.0f;
            evapoTranspirationState.canIce     = 0.0f;
            evapoTranspirationState.tv         = 300.0f;
            evapoTranspirationState.tg         = 300.0f;
            ...
            evapoTranspirationState.snIce[0]   = 0.0f;
            evapoTranspirationState.snIce[1]   = 0.0f;
            evapoTranspirationState.snIce[2]   = 0.0f;
            evapoTranspirationState.snLiq[0]   = 0.0f;
            evapoTranspirationState.snLiq[1]   = 0.0f;
            evapoTranspirationState.snLiq[2]   = 0.0f;
            evapoTranspirationState.lfMass     = 100000.0f;
            evapoTranspirationState.rtMass     = 100000.0f;
            evapoTranspirationState.stMass     = 100000.0f;
            evapoTranspirationState.wood       = 200000.0f;
            evapoTranspirationState.stblCp     = 200000.0f;
            evapoTranspirationState.fastCp     = 200000.0f;
            evapoTranspirationState.lai        = 4.6f;
            evapoTranspirationState.sai        = 0.6f;
            evapoTranspirationState.cm         = 0.002f;
            evapoTranspirationState.ch         = 0.002f;
            evapoTranspirationState.tauss      = 0.0f;
            evapoTranspirationState.deepRech   = 0.0f;
            evapoTranspirationState.rech       = 0.0f;
        }
